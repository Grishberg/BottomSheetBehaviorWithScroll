...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    private int mUntouchableAreaOffset = 0;
    ...
    public void setmUntouchableAreaOffset(int height) {
        mUntouchableAreaOffset = height;
    }
    ...
    public boolean onInterceptTouchEvent(CoordinatorLayout parent, V child, MotionEvent event) {
        ...
        if (shouldIgnoreTouchEvent(child, event) && action == MotionEvent.ACTION_DOWN) {
            return false;
        }
        // Record the velocity
    ...
    private boolean shouldIgnoreTouchEvent(V child, MotionEvent event) {
        if (mUntouchableAreaOffset == 0) {
            return false;
        }
        Log.d("BS", "shouldIgnore = " + (child.getTop() + mUntouchableAreaOffset > event.getY()));
        return child.getTop() + mUntouchableAreaOffset > event.getY();
    }
